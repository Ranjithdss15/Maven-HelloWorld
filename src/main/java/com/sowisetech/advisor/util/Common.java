...
public class Common {
	...
	public String validPasswordCheck(String inputParam, String inputParamPassword) {
		...
		// length:min=8,max=12
		String PASSWORD_REGEX = "((?=.*\\d)(?=.*[A-Z])(?=.*[@!^&*(+_?)#$%]).{8,12})";

		if (inputParam.matches(PASSWORD_REGEX) == false) {
	...
	public String dobCheck(String inputParam, String inputParamName) {
		String errorMsg = "";
		String dateRegex = "^[0-3][0-9]-[0-1][0-9]-[0-9]{4}$";
...
//		String regex = "^[A-Z]{1}[a-z]{2} [0-9]{4}-[A-Z]{1}[a-z]{2} [0-9]{4}|[A-Z]{1}[a-z]{2} [0-9]{4}-present|[A-Z]{1}[a-z]{2} [0-9]{4}-Present$";
