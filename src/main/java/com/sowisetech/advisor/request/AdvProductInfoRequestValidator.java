...
//				if (Common.allowMultipleText(product.getProduct(), inputParamName).isEmpty() == false) {
//					errors.put("PRODUCT", Common.allowMultipleText(product.getProduct(), inputParamName));
//				}
//			}
...
//				if (Common.allowMultipleText(product.getBrand(), inputParamName).isEmpty() == false) {
//					errors.put("BRAND", Common.allowMultipleText(product.getBrand(), inputParamName));
//				}
//			}
//			if (product.getRemuneration() != null) {
//				if (Common.isValidRemuneration(product.getRemuneration(), inputParamName).isEmpty() == false) {
//					errors.put("RENUMERATION", Common.isValidRemuneration(product.getRemuneration(), inputParamName));
//				}
//			}
//			if (product.getCertificate() != null) {
//				if (Common.allowMultipleText(product.getCertificate(), inputParamName).isEmpty() == false) {
//					errors.put("CERTIFICATE", Common.allowMultipleText(product.getCertificate(), inputParamName));
//				}
//			}
//			if (product.getLicNumber() != null) {
//				if (Common.allowMultipleLegalNo(product.getLicNumber(), inputParamName).isEmpty() == false) {
//					errors.put("LIC_NUMBER",
//							Common.allowMultipleLegalNo(product.getLicNumber(), inputParamName));
//				}
//			}
//			if (product.getIssuedBy() != null) {
//				if (Common.allowMultipleText(product.getIssuedBy(), inputParamName).isEmpty() == false) {
//					errors.put("ISSUED_BY", Common.allowMultipleText(product.getIssuedBy(), inputParamName));
//				}
//			}
			if (product.getValidity() != null) {
				if (common.isValidDate(product.getValidity(), inputParamName).isEmpty() == false) {
					errors.put("VALIDITY", common.isValidDate(product.getValidity(), inputParamName));
				}
			}
